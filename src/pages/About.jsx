...
export default function About() {
    return (
        <>
            ...
            {/* ORIGIN OF NAME — bg-[#EFECE5] */}
            <section className="bg-[#EFECE5]" id="story">
                <div className="max-w-6xl mx-auto px-6 md:px-8 grid grid-cols-1 md:grid-cols-2 items-center gap-10 py-16 md:py-[72px]">
                    ...
                    <div data-aos="fade-right" className="flex flex-col justify-center md:pr-6">
                        ...
                        <p className="text-[13.5px] text-gray-500 leading-[1.72] mb-4 max-w-[420px]">
                        ...
                        <p className="text-[13.5px] text-gray-500 leading-[1.72] max-w-[420px]">
                    ...
                    <div data-aos="fade-left" className="relative w-full rounded-2xl overflow-hidden h-[420px]">
                        <img src="./images/ozamiz.png" alt="Joaquin Velez Ozamiz" className="absolute inset-0 w-full h-full object-cover grayscale" />
            ...
            <section className="bg-slate-50 py-16 md:py-20">
                <div className="max-w-6xl mx-auto px-6 md:px-8">
                    ...
                    <div data-aos="fade-up" className="flex items-center gap-2.5 mb-3">
                        <div className="w-6 h-[1.5px] bg-brand shrink-0" />
                        <span className="text-[10px] font-bold tracking-[0.22em] uppercase text-brand">Through the Years</span>
                    </div>
                    <h2 data-aos="fade-up" className="text-[clamp(1.75rem,3vw,2.4rem)] font-extrabold text-navy tracking-tight leading-none mb-10">
                        History
                    </h2>

                    {/* History image */}
                    <div data-aos="fade-up" className="rounded-2xl overflow-hidden shadow-lg mb-12 h-[380px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                        ...
                        <div data-aos="fade-up" className="bg-white rounded-2xl p-6 md:p-7 border border-gray-100 hover:shadow-md transition-shadow duration-300">
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 bg-brand/10 rounded-xl flex items-center justify-center shrink-0 mt-0.5">
                                    <MapPin className="w-5 h-5 text-brand" />
                                </div>
                                <div>
                                    <span className="text-[0.68rem] font-bold text-gold uppercase tracking-widest">Pre-1900s – Early 1940s</span>
                        ...
                        <div data-aos="fade-up" data-aos-delay="100" className="bg-white rounded-2xl p-6 md:p-7 border border-gray-100 hover:shadow-md transition-shadow duration-300">
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 bg-brand/10 rounded-xl flex items-center justify-center shrink-0 mt-0.5">
                                    <Landmark className="w-5 h-5 text-brand" />
                                </div>
                                <div>
                                    <span className="text-[0.68rem] font-bold text-gold uppercase tracking-widest">16th Century</span>
                        ...
                        <div data-aos="fade-up" data-aos-delay="200" className="bg-white rounded-2xl p-6 md:p-7 border border-gray-100 hover:shadow-md transition-shadow duration-300">
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 bg-brand/10 rounded-xl flex items-center justify-center shrink-0 mt-0.5">
                                    <Shield className="w-5 h-5 text-brand" />
                                </div>
                                <div>
                                    <span className="text-[0.68rem] font-bold text-gold uppercase tracking-widest">World War II</span>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="bg-white rounded-2xl p-6 md:p-7 border border-gray-100 hover:shadow-md transition-shadow duration-300">
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 bg-brand/10 rounded-xl flex items-center justify-center shrink-0 mt-0.5">
                                    <Building2 className="w-5 h-5 text-brand" />
                                </div>
                                <div>
                                    <span className="text-[0.68rem] font-bold text-gold uppercase tracking-widest">Present Day</span>
            ...
            <section className="bg-blue-50 py-16 md:py-20">
                <div className="max-w-6xl mx-auto px-6 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
                    ...
                    <div data-aos="fade-right">
                        ...
                        <ul className="flex flex-col gap-3 list-none p-0 m-0">
                            <li className="flex items-center gap-3 text-gray-500 text-sm">
                                <ChevronRight className="w-4 h-4 text-brand shrink-0" />Northern Mindanao
                            </li>
                            <li className="flex items-center gap-3 text-gray-500 text-sm">
                                <ChevronRight className="w-4 h-4 text-brand shrink-0" />Misamis Occidental Province
                            </li>
                            <li className="flex items-center gap-3 text-gray-500 text-sm">
                                <ChevronRight className="w-4 h-4 text-brand shrink-0" />Along Panguil Bay
                            </li>
                            <li className="flex items-center gap-3 text-gray-500 text-sm">
                                <ChevronRight className="w-4 h-4 text-brand shrink-0" />In Misamis Occidental
                            </li>
                            <li className="flex items-center gap-3 text-gray-500 text-sm">
                                <ChevronRight className="w-4 h-4 text-brand shrink-0" />Coastal city
                            </li>
                        </ul>
                    </div>
                    ...
                    <div data-aos="fade-left" data-aos-delay="150">
                        ...
                        <ul className="flex flex-col gap-3 list-none p-0 m-0">
                            <li className="flex items-center gap-3 text-gray-500 text-sm">
                                <ChevronRight className="w-4 h-4 text-brand shrink-0" />163,000+ residents
                            </li>
                            <li className="flex items-center gap-3 text-gray-500 text-sm">
                                <ChevronRight className="w-4 h-4 text-brand shrink-0" />54 barangays
                            </li>
                            <li className="flex items-center gap-3 text-gray-500 text-sm">
                                <ChevronRight className="w-4 h-4 text-brand shrink-0" />Cebuano speaking
                            </li>
                            <li className="flex items-center gap-3 text-gray-500 text-sm">
                                <ChevronRight className="w-4 h-4 text-brand shrink-0" />Filipino & English used
                            </li>
                            <li className="flex items-center gap-3 text-gray-500 text-sm">
                                <ChevronRight className="w-4 h-4 text-brand shrink-0" />Diverse natives
                            </li>
                        </ul>
                    </div>
            ...
            <section className="bg-slate-50 py-16 md:py-20" id="map">
                <div className="max-w-6xl mx-auto px-6 md:px-8">
                    ...
                    <h2 data-aos="fade-up" className="text-[clamp(1.75rem,3vw,2.4rem)] font-extrabold text-navy tracking-tight leading-none mb-8">
                        Location
                    </h2>

                    <div data-aos="fade-up" className="rounded-2xl overflow-hidden border border-gray-100 shadow-lg h-[420px]">
                        <iframe
